...
public class SmsCaptchaGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        OAuth2AccessToken accessToken = new OAuth2AccessToken(OAuth2AccessToken.TokenType.BEARER,
                ...
                expireAt, tokenContext.getAuthorizedScopes());
        ...
        if (authorizedScopes.contains(OidcScopes.OPENID)) {
            ...
            idToken = new OidcIdToken(generatedIdToken.getTokenValue(), generatedIdToken.getIssuedAt(),
                    expireAt, ((Jwt) generatedIdToken).getClaims());
...
//        phone = 前端传进来的用户名
//        smsCaptcha = 前端传进来的短信验证码

        //代码区块开始
        //将前端传进来的短信校验码 当作密码进行校验。
        //这一句话就是authenticationManager.authenticate 用户名密码校验

        //校验对了就返回认证token authenticate
        //
        //
        ...
        //以上代码块 如果时换成短信校验码校验，可以自定义校验，然后如果对了就返回 SmsCaptchaGrantAuthenticationToken
